...
class New_vendor_form(forms.Form):
    ...
    customer_specific_property = forms.CharField(max_length=1000 ,required=False, widget=forms.TextInput(attrs=register_attrs))


    #Vendor properties

    vendor_specific_property = forms.CharField(max_length=255  ,required=True, widget=forms.TextInput(attrs=register_attrs))

    store_deposit_account = forms.CharField(max_length = 32 ,required=True , widget=forms.TextInput(attrs=register_attrs))
